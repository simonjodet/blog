...
$sql = 'CREATE TABLE "posts" ("id" INTEGER AUTOINCREMENT PRIMARY KEY NOT NULL UNIQUE, "post" TEXT NOT NULL, "title" TEXT NOT NULL, "date" TEXT NOT NULL, "content" TEXT NOT NULL);';
sqlite_query($db, $sql);
...
foreach($raw_posts as $raw_post){
    ...
    sqlite_query($db, 'INSERT INTO posts (post, title, date, content) VALUES ("'.$post['post'].'","'.$post['title'].'","'.$post['date'].'","'.$post['content'].'")');
    $posts[] = $post;
}
sqlite_close($db);